...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/twilight-flower-ea0b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-flower-ea0b
```

A live public deployment of this template is available at [https://twilight-flower-ea0b.templates.workers.dev](https://twilight-flower-ea0b.templates.workers.dev)
